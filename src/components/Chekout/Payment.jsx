...
import { Container, Row, Col, Card, Button, Collapse, Form, Modal } from 'react-bootstrap';
...
const Payment = ({ formData }) => {
    ...
    // protect
    useEffect(() => {
        if (!location.state.flight || !location.state.passengerTypes || !location.state.bookingCode) {
            nav('/');
        }
    }, [location, nav]);
            ...
            <Container fluid className="p-0 m-0 shadow py-4">
                <Container>
                    <Row className="mt-5">
                        ...
                        <Col>
                            <div className="p-3 m-0" style={{ backgroundColor: 'red', borderRadius: '12px' }}>
                                <Card.Body>
                                    <p
                ...
                <Row>
                    <Col sm={8}>
                        ...
                        <Card className="border-0" style={{ background: 'none' }}>
                            ...
                            >
                                Credit Card{' '}
                                {collapseStates.creditCard ? <BsChevronUp size={20} /> : <BsChevronDown size={20} />}
                            </Button>
                        ...
                        <Card className="border-0 text-white" style={{ background: 'none' }}>
                            ...
                            <Modal show={isPaymentModalOpen} onHide={() => setIsPaymentModalOpen(false)}>
